...
$Notebook = Join-Path $ProjectRoot "notebooks reviewed\01_QGAIN\02b_gain_dynamics_QGAIN_v4_1_0_FIGURE_COMPLETION_LOCAL_RUN.ipynb"
$Python = Join-Path $ProjectRoot ".venv\Scripts\python.exe"
$TestFile = Join-Path $ProjectRoot "tests reviewed\test_qgain_figure_completion_v100.py"
...
Copy-Item -LiteralPath (Join-Path $ProjectRoot "src reviewed\paper1_qc_reviewed\qgain_figure_completion_v100.py") -Destination $Prov -Force
