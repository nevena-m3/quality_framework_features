...
$NotebookDir = Join-Path $ProjectRoot "notebooks reviewed\02_QADD"

$RequiredInputs = @(
    $Python,
    $Candidate,
    (Join-Path $ProjectRoot "src reviewed\paper1_qc_reviewed\qadd_v420.py"),
    (Join-Path $ProjectRoot "src reviewed\paper1_qc_reviewed\qadd_v420_cohort.py"),
    (Join-Path $ProjectRoot "src reviewed\paper1_qc_reviewed\qadd_v420_final.py"),
    (Join-Path $ProjectRoot "tests reviewed\test_qadd_v420.py"),
    (Join-Path $ProjectRoot "tests reviewed\test_qadd_v420_cohort.py"),
    (Join-Path $ProjectRoot "tests reviewed\test_qadd_v420_final.py"),
...
try {
    & $Python -m pytest `
        "tests reviewed\test_qadd_v420.py" `
        "tests reviewed\test_qadd_v420_cohort.py" `
        "tests reviewed\test_qadd_v420_final.py" `
        -q `
        --disable-warnings
    if ($LASTEXITCODE -ne 0) {
...
$ProvenanceFiles = @(
    "src reviewed\paper1_qc_reviewed\qadd_v420.py",
    "src reviewed\paper1_qc_reviewed\qadd_v420_cohort.py",
    "src reviewed\paper1_qc_reviewed\qadd_v420_final.py",
    "tests reviewed\test_qadd_v420.py",
    "tests reviewed\test_qadd_v420_cohort.py",
    "tests reviewed\test_qadd_v420_final.py",
    "notebooks reviewed\02_QADD\QADD_V4_2_0_FREEZE_CONTRACT.md",
    "notebooks reviewed\02_QADD\QADD_v420_FINAL_SCIENTIFIC_AUDIT.md",
    "notebooks reviewed\02_QADD\QADD_v420_FINAL_FEATURE_DECISIONS.csv",
    "notebooks reviewed\02_QADD\QADD_Family_Evaluation_Workbook_v1_0.docx",
    "notebooks reviewed\02_QADD\QADD_Validation_Checklist_v1_0.csv",
    "notebooks reviewed\02_QADD\QADD_Ten_Domain_Dashboard_v1_0.csv"
)
