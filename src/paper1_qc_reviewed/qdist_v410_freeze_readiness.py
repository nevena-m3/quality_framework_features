...
def provenance_files(project_root: Path) -> list[Path]:
    candidates = [
        ...
        project_root
        / "src/paper1_qc_reviewed/qdist_v410_cohort.py",
        project_root
        / "src/paper1_qc_reviewed/qdist_v410_computational_verification.py",
        project_root
        / "src/paper1_qc_reviewed/qdist_v410_freeze_readiness.py",
        project_root / "tests/test_qdist_v410_candidate.py",
        project_root
        / "tests/test_qdist_v410_computational_verification.py",
        project_root
